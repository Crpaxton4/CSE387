...
class CameraComponent : public Component
{
	...
	/**
	* Constructor. By default, Cameras render to the
	* entire window with a depth of zero. Constructed cameras
	* are added to the static activeCameras vector.
	*/
	...
	*/
	...
	/**
	* Set the depth for the Camera to a non-negative value. View of the scene with the higher
	* depth value is rendered on top of camera with lower depth value. Calls to this method
	* should cause the activeCameras vector to be sorted by depth from smallest to largest each
	* time this method is called.
	* @param depth non-negative depth value for the camera.
	*/
	void setDepth( int depth );

	// Vector containing the Cameras that are enabled. The vector should be sorted based upon 
	// the depth values of the cameras. Figure out how to the use STL sort method to make this 
	// happen.
