...
SoundSourceComponent::SoundSourceComponent( Actor* owner, std::string soundFileName, float mindist, float maxdist, FMOD_MODE fmod_mode )
	: SoundBaseComponent( owner ), soundFileName( soundFileName ), fmod_mode( fmod_mode ),
