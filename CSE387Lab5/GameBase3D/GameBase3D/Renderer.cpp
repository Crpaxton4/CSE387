...
void Renderer::Resize( )
{
	...
	mProjectionMat = glm::ortho( -mScreenWidth / 2.0f, mScreenWidth / 2.0f, -mScreenHeight / 2.0f, mScreenHeight / 2.0f, 0.0f, 2.0f );
	...
	mProjectionMat = glm::perspective( glm::radians( 45.0f ), static_cast<float>( mScreenWidth ) / mScreenHeight, 1.0f, 100.0f );
