...
SphereMesh::SphereMesh( GLfloat radius, GLint stacks, GLint slices )
...
bool SphereMesh::Load( const std::string & fileName, Material material )
{
	initializeTop( );
	initializeBody( );
	initializeBottom( );
...
void SphereMesh::initializeBody( )
{
...
void SphereMesh::initializeBottom( )
{
